...
export class UpgradeBoard extends InteractiveObject {
    ...
    upgrades() {
        ...
        const townUpgradeCosts = [
            ...
            new TownUpgrade(this.scene, 4, 3, "town", "Your town grows with new merchants and craftsfolk joining."),
            new TownUpgrade(this.scene, 5, 4, "town", "Your townsfolk gather to build a bridge across the river."),
            new TownUpgrade(this.scene, 6, 5, "town", "Another bridge will be built by your people, and more join."),
            7,
            8,
            9,
            10
